class Interface: 
        ...
        sfont_size = int(DISPLAY_WIDTH * 0.038)
        font_size = int(DISPLAY_WIDTH * 0.064)
        lfont_size = int(DISPLAY_WIDTH * 0.075)
        smallfont = pygame.font.SysFont('arial', sfont_size, bold=False, italic=False)
        font = pygame.font.SysFont('arial', font_size, bold=False, italic=False)
        font_bold = pygame.font.SysFont('arial', lfont_size, bold=True, italic=True) #setting text font and size 
        screen.fill(WHITE)
